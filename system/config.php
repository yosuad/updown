...
// Uploader settings
$filelist = 'jpeg,jpg,gif,png,zip,xls,doc,mp3,mp4,mpeg,wav,avi,rar,7z,txt,pdf,ppt,docx,xlsx';
...
$filedestination = getenv('APP_FILE_DESTINATION');
if (!$filedestination) {
    $filedestination = __DIR__ . '/../uploads'; // o donde quieras guardar los archivos
}
